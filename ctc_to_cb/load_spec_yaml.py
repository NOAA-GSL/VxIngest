...
class LoadYamlSpecFile:
    ...
    def __init__(self, args):
        ...
        self.load_spec = {'cb_connection': {'host': None, 'user': None, 'password': None, }, 'email': None, 'ingest_document_ids': []}
        self.yaml_data = {}
            ...
            for c_key in self.connection_list:
                ...
                for k in c_keys:
                    try:
                        ...
                        logging.warning("yaml file: %s is missing key: load_spec[%s]['%s'] - using default", self.spec_file_name, c_key, k)
