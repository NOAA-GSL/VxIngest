...
def test_cb_connect_disconnect():
    ...
    try:
        ...
        result = vx_ingest_manager.cluster.query(
...
def test_build_load_job_doc():
    ...
    try:
        ...
        assert ljd["id"].startswith("LJ:METAR:ctc_to_cb.run_ingest_threads:VXIngest"), f"load_job ID is wrong: {ljd['id']} does not start with 'LJ:METAR:ctc_to_cb.run_ingest_threads:VXIngest'"
    except Exception as _e:  # pylint:disable=broad-except
