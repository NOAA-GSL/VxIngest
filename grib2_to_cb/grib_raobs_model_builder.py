"""
Program Name: Class GribRaobModelBuilder
...
# Concrete builders
class RaobModelBuilder(GribBuilder):  # pylint:disable=too-many-instance-attributes
    """
    This is the parent builder for RAOB model data that is ingested from grib2 files.
    """
...
class RaobModelNativeBuilder(RaobModelBuilder):  # pylint:disable=too-many-instance-attributes
    """
    This is the builder for RAOB model data that is ingested from grib2 files
    an is using native levels.
    """
...
class RaobModelPressureLevelBuilder(RaobModelBuilder):  # pylint:disable=too-many-instance-attributes
    """
    This is the builder for RAOB model data that is ingested from grib2 files
    an is using pressure levels.
    """
