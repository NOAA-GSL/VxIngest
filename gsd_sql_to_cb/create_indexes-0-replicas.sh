...
CREATE INDEX `adv_geo_lat_geo_lon_type_docType_subset_version` ON `mdata`((`geo`.`lat`),(`geo`.`lon`)) WHERE ((((`docType` = "station") and (`subset` = "METAR")) and (`version` = "V03")) and (`type` = "DD"))
