...
cbimport json --cluster couchbase://${host} --bucket mdata --username ${user} --password ${pwd} --format list --generate-key %id% --dataset file://${PWD}/VxData/mats_metadata_and_indexes/metadata_files/ingest_models_from_grib.json
