...
require (
	...
	github.com/couchbase/gocbcoreps v0.0.0-20231113141308-5f0347744035 // indirect
	github.com/couchbase/goprotostellar v0.0.1-3.0.20231102140456-4b5bcf407d9d // indirect
