...
from netcdf_to_cb.netcdf_ingest_manager import NetcdfIngestManager
...
class VXIngestNetcdf(object):
    ...
    def runit(self, args):
        ...
        self.first_last_params = {key: val for key, val in args.items() if key.startswith('{')}
            ...
            with os.scandir(path) as entries:
                for entry in entries:
                    ...
                    if self.first_last_params is not None:
                        ...
                        file_time = (utc_time - datetime(1970, 1, 1)).total_seconds()  
        ...
        # instantiate ingest_manager pool - each ingest_manager is a
        ...
        for _threadCount in range(int(self.thread_count)):
            ...
            try:
                ingest_manager_thread = NetcdfIngestManager(
                    "NetcdfIngestManager-" + str(self.thread_count), load_spec, q)
