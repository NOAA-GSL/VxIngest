...
You also need a .vscode/launch.json that looks something like
{
    ...
    "configurations": [
        ...
        },
        {
            ...
            "args": ["-j JOB:V01:METAR:NETCDF:OBS",
        ...
        {
            "name": "Run gsd ingest ctc HRRR_RAP_130 V01",
            "type": "python",
            "request": "launch",
            "program": "${workspaceFolder}/ctc_to_cb/run_ingest_threads.py",
            "args": ["-j JOB:V01:METAR:CTC:SUM:MODEL:HRRR_RAP_130",
                "-c ${env:HOME}/adb-cb1-credentials",
                "-o /tmp"
            ],
            "console": "integratedTerminal",
...
For example if you click on the test_unit_queries.py line all of the tests in that class will be run. Initially a blue elispis (...) shows up to the left of each test item. This icon will change to a
red X or a green checkmark depending on whether or not the test passes.
