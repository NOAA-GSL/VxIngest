...
python ctc_to_cb/run_ingest_threads.py -s /data/ctc_to_cb/load_specs/load_spec_metar_ctc_retro_V01.yaml  -c ~/adb-cb1-credentials -o /data/ctc_to_cb-retro/output -t8
