...
python netcdf_to_cb/run_ingest_threads.py -s /data/netcdf_to_cb-retro/load_specs/load_spec_netcdf_metar_legacy_retro_obs_V01.yaml -c ~/adb-cb1-credentials -p /couchbase/xfer/ -m %Y%m%d_%H%M -o /data/netcdf_to_cb-retro/output -t8
