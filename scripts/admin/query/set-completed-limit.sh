...
# ***********************************************************************************************************
# set-completed-limit.sh
#
#   Usage: ./set-completed-limit.sh [options]
#
#   Sets the Query Service Completed Limit on all Query Nodes in the Cluster
#
#   Options:
#
...
#     --limit=<n>             The number of completed queries over the threshold to keep (default: 4000)
# ***********************************************************************************************************
