...
# ***********************************************************************************************************
# set-completed-threshold.sh
#
#   Usage: ./set-completed-threshold.sh [options]
#
#   Sets the Query Service Completed Threshold on all Query Nodes in the Cluster
#
#   Options:
#
...
#     --threshold=<n>         The completed-threshold value in milliseconds (default: 1000)
# ***********************************************************************************************************
...
do
  ...
  response=$(curl \
    ...
    --silent \
    --request POST \
    --data "{\"completed-threshold\":$THRESHOLD}" \
    --write-out "%{http_code}" \
    --output /dev/null \
