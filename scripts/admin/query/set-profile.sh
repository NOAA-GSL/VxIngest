...
# set-profile.sh
#
#   Usage: ./set-profle.sh [options]
#
#   Sets the Query Service Profile value on all Query Nodes in the Cluster
#
#   Options:
#
...
#     --profile=<s>           The timings to use, valid values are "off", "phases" or "timings" (default: "off")
# ***********************************************************************************************************
...
QUERY_PROFILE=${QUERY_PROFILE:='off'}
