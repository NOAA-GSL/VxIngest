...
# ***********************************************************************************************************
# all-buckets-analytics-stats-for-node.sh
#
#   Usage: ./all-buckets-analytics-stats-for-node.sh [options]
#
#   This will output the analytics stats for a specific node and all buckets in the cluster, and explicitly
...
# loop over each bucket using analytics
for bucket in $(curl \
