...
# ***********************************************************************************************************
# all-buckets-analytics-stats.sh
#
#   Usage: ./all-buckets-analytics-stats.sh [options]
#
#   This will output the analytics stats for all buckets in the cluster, and explicitly
...
# loop over each of the buckets that is attached to analytics
for bucket in $(curl \
