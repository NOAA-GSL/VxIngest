...
# ***********************************************************************************************************
# analytics-service-stats-by-node.sh
#
#   Usage: ./analytics-service-stats-by-node.sh [options]
#
#   This will output the analytics stats for the service for each node in the cluster
#
#   Options:
#
...
do
  ...
  curl \
    --user "$CB_USERNAME:$CB_PASSWORD" \
    --silent \
    "$PROTOCOL://$CLUSTER:$PORT/pools/default/buckets/@cbas/nodes/$node/stats?zoom=$ZOOM" | \
