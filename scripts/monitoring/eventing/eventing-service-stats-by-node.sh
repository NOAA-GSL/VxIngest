...
# ***********************************************************************************************************
# eventing-service-stats-by-node.sh
#
#   Usage: ./eventing-service-stats-by-node.sh [options]
#
#   This will output the eventing stats for the service for each node in the cluster
#
#   Options:
#
