...
# ***********************************************************************************************************
# fts-service-stats.sh
#
#   Usage: ./fts-service-stats.sh [options]
#
#   This will output the fts service stats for the cluster
#
#   Options:
#
...
curl \
  ...
  --silent \
  "$PROTOCOL://$CLUSTER:$PORT/pools/default/buckets/@fts/stats" | \
