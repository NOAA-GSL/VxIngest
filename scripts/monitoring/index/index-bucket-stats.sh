...
# ***********************************************************************************************************
# index-bucket-stats.sh
#
#   Usage: ./index-bucket-stats.sh [options]
#
#   This will gather all of the index stats for a bucket across the cluster.
#
#   Options:
#
...
#     --bucket=<s>            The name of the bucket (default: defualt)
