...
# ***********************************************************************************************************
# query-stats-by-node.sh
#
#   Usage: ./query-stats-by-node.sh [options]
#
#   This will output the query stats for the query service for each node in the cluster
#
#   Options:
#
