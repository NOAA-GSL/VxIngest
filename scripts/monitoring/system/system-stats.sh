...
# system-stats.sh
#
#   Usage: ./system-stats.sh [options]
#
#   This will output the system stats for all ndoes in the cluster, and explicitly
...
curl \
  ...
  --silent \
  "$PROTOCOL://$CLUSTER:$PORT/pools/default/buckets/@system/stats?zoom=$ZOOM" | \
