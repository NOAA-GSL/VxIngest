...
# xdcr-stats.sh
#
#   Usage: ./xdcr-stats.sh [options]
#
#   This will output the xdcr stats for all buckets in the cluster, and explicitly
...
do
  ...
  curl \
    ...
    # who are xdcr specific stat properties and either sum or average samples
