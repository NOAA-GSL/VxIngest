...
class CbQueriesTimeSeriesStations {
    ...
    processStationQuery() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var sqlstrObs = fs_1.default.readFileSync("./SQLs/get_N_stations_obs.sql", 'utf-8');
            ...
            */
            ...
            var sqlstrModel = fs_1.default.readFileSync("./SQLs/get_N_stations_model.sql", 'utf-8');
