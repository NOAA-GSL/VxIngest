...
def test_one_thread_specify_file_pattern(tmp_path: Path):
    ...
    #         "82705",
    #     ]:
        print("Testing station: ", stn)
        vx_ingest.write_data_for_station = stn
        vx_ingest.write_data_for_level = 500
        vx_ingest.runit(
            {
        ...
        continue  # Data is NOT YET LOADED INTO THE DATABASE - REMOVE THIS WHEN DATA IS READY!
